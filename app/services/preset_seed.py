...
PRESET_DEFS = [
    ...
    ("sdxl_2d_face_pilot_3epoch", "SDXL 2D Face - Pilot 3 Epoch", "SDXL", "sdxl_train_network.py", "実用LoRA評価前の短時間テスト。品質完成ではなく、loss推移・epoch差・sample比較の確認用。", 40, 80, {"optimizer_type":"AdamW8bit","lr_scheduler":"cosine","learning_rate":0.0001,"unet_lr":0.0001,"text_encoder_lr":0,"network_train_unet_only":True,"network_dim":32,"network_alpha":16,"train_batch_size":2,"repeats":2,"max_train_epochs":3,"resolution":"1024,1024","min_snr_gamma":5,"clip_skip":2,"save_every_n_epochs":1,"sample_every_n_epochs":1}, "50枚前後のデータセットで、各epochの差とloss推移を短時間で確認する。", "完成品質ではない。顔再現が弱い可能性があるが、まずは評価導線の確認を優先する。"),
    ("sdxl_2d_face_pilot_generalize_3epoch", "SDXL 2D Face - Pilot Generalize 3 Epoch", "SDXL", "sdxl_train_network.py", "固定化・過学習を避ける弱めの短時間テスト。", 40, 80, {"optimizer_type":"AdamW8bit","lr_scheduler":"cosine","learning_rate":0.00005,"unet_lr":0.00005,"text_encoder_lr":0,"network_train_unet_only":True,"network_dim":16,"network_alpha":8,"train_batch_size":2,"repeats":2,"max_train_epochs":3,"resolution":"1024,1024","min_snr_gamma":5,"clip_skip":2,"save_every_n_epochs":1,"sample_every_n_epochs":1}, "50枚前後のデータセットで、弱め設定のepoch差とloss推移を短時間で確認する。", "完成品質ではない。固定化を避けるぶん顔再現が弱い可能性がある。"),
