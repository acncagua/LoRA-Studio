...
def seed_embedding_models(conn: sqlite3.Connection) -> None:
    ...
    rows = [
        ...
        {
            "id": "open_clip_vit_b32_laion2b",
            "name": "OpenCLIP ViT-B-32 LAION2B",
            "provider": "open_clip",
            "model_name": "ViT-B-32",
            ...
            "batch_size_default": 8,
            "allow_download": 1,
            "memo": "Phase 11.5の試験provider。標準モデルはViT-B-32 / laion2b_s34b_b79kです。downloadは明示許可時のみ行います。",
        },
        {
...
CREATE TABLE IF NOT EXISTS optimizer_mini_pilot_runs (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    status TEXT NOT NULL DEFAULT 'planned',
    target_scope TEXT,
    project_id INTEGER,
    ...
    elapsed_seconds INTEGER,
    total_count INTEGER DEFAULT 0,
    mini_pilot_ok_count INTEGER DEFAULT 0,
    failed_count INTEGER DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS optimizer_mini_pilot_items (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    mini_pilot_run_id INTEGER,
    optimizer_definition_id TEXT,
    optimizer_profile_id TEXT,
    recipe_id TEXT,
    status TEXT NOT NULL DEFAULT 'planned',
    ...
    output_lora_sha256 TEXT,
    output_lora_file_size INTEGER,
    output_model_count INTEGER DEFAULT 0,
    sample_image_count INTEGER DEFAULT 0,
    mini_validation_image_count INTEGER DEFAULT 0,
    initial_loss REAL,
    final_loss REAL,
    min_loss REAL,
    max_loss REAL,
    moving_avg_final_loss REAL,
    nan_loss_count INTEGER DEFAULT 0,
    inf_loss_count INTEGER DEFAULT 0,
    loss_status TEXT,
    artifact_status TEXT,
    image_smoke_status TEXT,
    machine_review_status TEXT,
    reference_similarity_avg REAL,
    nearest_dataset_similarity_avg REAL,
    overfit_risk_label TEXT,
    failure_category TEXT,
    error_message TEXT,
    log_path TEXT,
    report_path TEXT,
